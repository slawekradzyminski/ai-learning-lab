  ...
  return (
    <div className="space-y-10 learning-enter" data-testid="agent-course-lesson-view">
      ...
      <nav className="flex flex-wrap items-center gap-x-7 gap-y-3 border-b border-stone-200 pb-5 text-xs font-semibold" aria-label="Lesson materials">
        ...
        {lesson.slide ? <Link to={`/learn/how-ai-agent-works/slides?slide=${lesson.slide}`} className="inline-flex items-center gap-2 text-slate-600 hover:text-amber-700"><Presentation className="h-3.5 w-3.5" /> Presenter slides</Link> : null}
      </nav>
