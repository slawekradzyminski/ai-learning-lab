...
export const AGENT_COURSE_LESSONS: AgentCourseLesson[] = [
  {
    ...
    educational: AGENT_LESSON_THEORY['agent-loop'], activity: 'agent-loop',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY.subagents, activity: 'subagents',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY['context-harness'], activity: 'context-harness',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY['memory-instructions'], activity: 'memory-instructions',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY['hooks-lifecycle'], activity: 'hooks-lifecycle',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY['tool-boundaries'], activity: 'tool-boundaries',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY['agent-evals'], activity: 'agent-evals',
  ...
  },
  {
    ...
    educational: AGENT_LESSON_THEORY.capstone, activity: 'capstone',
