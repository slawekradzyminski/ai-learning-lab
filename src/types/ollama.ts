...
export interface LearningTokenCountRequest {
  model: string;
  prompt: string;
}

export interface LearningTokenCountResponse {
  source: 'ollama-live';
  modelLabel: string;
  prompt: string;
...
export interface LearningEmbeddingRequest {
  model: string;
  inputs: string[];
}

export interface LearningEmbeddingResponse {
  source: 'ollama-live';
  modelLabel: string;
  dimensions: number;
  promptTokenCount: number;
